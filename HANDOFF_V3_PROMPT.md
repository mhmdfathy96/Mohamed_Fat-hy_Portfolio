# About Me & Skills — Content Update
...
Please **extend** the Skills section by adding the following items.
...
- These skills must appear clearly under the Skills section
- Backend skills must not be hidden or merged under mobile skills
- Keep the same visual style used for other skill groups
