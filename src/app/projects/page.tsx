...
export default function ProjectsPage() {
  ...
  return (
    <section className="relative py-20 md:py-32">
      <div
        aria-hidden
        className="absolute inset-x-0 top-0 h-[28rem] -z-10 bg-[radial-gradient(circle,rgba(0,0,0,0.08)_1px,transparent_1px)] [background-size:22px_22px] [mask-image:linear-gradient(to_bottom,black,transparent)]"
      />
      <div className="max-w-5xl mx-auto px-6">
        <div className="mb-12">
          <div className="text-xs font-semibold text-blue-600 mb-3 uppercase tracking-[0.2em]">
            Case Studies
          </div>
